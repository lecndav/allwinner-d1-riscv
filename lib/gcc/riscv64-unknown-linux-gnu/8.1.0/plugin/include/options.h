...
#endif
#ifdef GENERATOR_FILE
extern int riscv_bit_translate;
#else
  int x_riscv_bit_translate;
#define riscv_bit_translate global_options.x_riscv_bit_translate
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int riscv_cbranch32;
#else
  int x_riscv_cbranch32;
#define riscv_cbranch32 global_options.x_riscv_cbranch32
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int flag_delete_redundancy_sext;
#else
  int x_flag_delete_redundancy_sext;
#define flag_delete_redundancy_sext global_options.x_flag_delete_redundancy_sext
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int flag_des_losum;
#else
  int x_flag_des_losum;
#define flag_des_losum global_options.x_flag_des_losum
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int flag_interrupt_consecutive_branch;
#else
  int x_flag_interrupt_consecutive_branch;
#define flag_interrupt_consecutive_branch global_options.x_flag_interrupt_consecutive_branch
#endif
#ifdef GENERATOR_FILE
extern int flag_interrupt_consecutive_branch2;
#else
  int x_flag_interrupt_consecutive_branch2;
#define flag_interrupt_consecutive_branch2 global_options.x_flag_interrupt_consecutive_branch2
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int riscv_ldd_more;
#else
  int x_riscv_ldd_more;
#define riscv_ldd_more global_options.x_riscv_ldd_more
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int riscv_opt_lbu;
#else
  int x_riscv_opt_lbu;
#define riscv_opt_lbu global_options.x_riscv_opt_lbu
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int riscv_strip_sextw;
#else
  int x_riscv_strip_sextw;
#define riscv_strip_sextw global_options.x_riscv_strip_sextw
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int riscv_insn_tst;
#else
  int x_riscv_insn_tst;
#define riscv_insn_tst global_options.x_riscv_insn_tst
#endif
#ifdef GENERATOR_FILE
...
#define MASK_HARD_FLOAT (1U << 8)
#define MASK_MUL (1U << 9)
#define MASK_RVC (1U << 10)
#define MASK_RVE (1U << 11)
#define MASK_VECTOR (1U << 12)
#define MASK_XTHEAD (1U << 13)
...
enum opt_code
{
  ...
  OPT_fcilkplus_Undocumented = 559,          /* -fcilkplus Undocumented */
  ...
  OPT_m4k_opts = 1190,                       /* -m4k-opts */
  OPT_mabi_ = 1191,                          /* -mabi= */
  OPT_maddsl = 1192,                         /* -maddsl */
  OPT_maddsluw = 1193,                       /* -maddsluw */
  OPT_march_ = 1194,                         /* -march= */
  OPT_mbionic = 1195,                        /* -mbionic */
  OPT_mbit_translate = 1196,                 /* -mbit-translate */
  OPT_mbranch_cost_ = 1197,                  /* -mbranch-cost= */
  OPT_mcbranch32 = 1198,                     /* -mcbranch32 */
  OPT_mcmodel_ = 1199,                       /* -mcmodel= */
  OPT_mcondmv = 1200,                        /* -mcondmv */
  OPT_mdelete_redundancy_sext = 1201,        /* -mdelete-redundancy-sext */
  OPT_mdelete_vsetvl = 1202,                 /* -mdelete-vsetvl */
  OPT_mdiv = 1203,                           /* -mdiv */
  OPT_mdse_losum = 1204,                     /* -mdse-losum */
  OPT_mexpand_split_imm = 1205,              /* -mexpand-split-imm */
  OPT_mexplicit_relocs = 1206,               /* -mexplicit-relocs */
  OPT_mext = 1207,                           /* -mext */
  OPT_mfclass = 1208,                        /* -mfclass */
  OPT_mfdiv = 1209,                          /* -mfdiv */
  OPT_mfldr = 1210,                          /* -mfldr */
  OPT_mfmvhw32 = 1211,                       /* -mfmvhw32 */
  OPT_mfp16 = 1212,                          /* -mfp16 */
  OPT_mglibc = 1213,                         /* -mglibc */
  OPT_minterrupt_consecutive_branch = 1214,  /* -minterrupt-consecutive-branch */
  OPT_minterrupt_consecutive_branch2 = 1215, /* -minterrupt-consecutive-branch2 */
  OPT_mipush = 1216,                         /* -mipush */
  OPT_miv_adjust_addr_cost = 1217,           /* -miv-adjust-addr-cost */
  OPT_mldd = 1218,                           /* -mldd */
  OPT_mldd_more = 1219,                      /* -mldd-more */
  OPT_mldi = 1220,                           /* -mldi */
  OPT_mldr = 1221,                           /* -mldr */
  OPT_mmula = 1222,                          /* -mmula */
  OPT_mmusl = 1223,                          /* -mmusl */
  OPT_mopt_lbu = 1224,                       /* -mopt-lbu */
  OPT_mplt = 1225,                           /* -mplt */
  OPT_mpreferred_stack_boundary_ = 1226,     /* -mpreferred-stack-boundary= */
  OPT_mrelax = 1227,                         /* -mrelax */
  OPT_mrev = 1228,                           /* -mrev */
  OPT_mrevw = 1229,                          /* -mrevw */
  OPT_msave_restore = 1230,                  /* -msave-restore */
  OPT_msignedness_cmpiv = 1231,              /* -msignedness-cmpiv */
  OPT_msmall_data_limit_ = 1232,             /* -msmall-data-limit= */
  OPT_msrri = 1233,                          /* -msrri */
  OPT_msrriw = 1234,                         /* -msrriw */
  OPT_mstrict_align = 1235,                  /* -mstrict-align */
  OPT_mstrip_sextw = 1236,                   /* -mstrip-sextw */
  OPT_mthread_jumps1 = 1237,                 /* -mthread-jumps1 */
  OPT_mtst = 1238,                           /* -mtst */
  OPT_mtune_ = 1239,                         /* -mtune= */
  OPT_muclibc = 1240,                        /* -muclibc */
  OPT_mvlen_ = 1241,                         /* -mvlen= */
  OPT_mxor_combine = 1242,                   /* -mxor-combine */
  OPT_n = 1243,                              /* -n */
  OPT_no_canonical_prefixes = 1244,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1245,              /* -no-integrated-cpp */
  OPT_no_pie = 1246,                         /* -no-pie */
  OPT_nocpp = 1247,                          /* -nocpp */
  OPT_nodefaultlibs = 1248,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1249,                   /* -nostartfiles */
  OPT_nostdinc = 1250,                       /* -nostdinc */
  OPT_nostdinc__ = 1251,                     /* -nostdinc++ */
  OPT_nostdlib = 1252,                       /* -nostdlib */
  OPT_o = 1253,                              /* -o */
  OPT_p = 1254,                              /* -p */
  OPT_pass_exit_codes = 1255,                /* -pass-exit-codes */
  /* OPT_pedantic = 1256, */                 /* -pedantic */
  OPT_pedantic_errors = 1257,                /* -pedantic-errors */
  OPT_pg = 1258,                             /* -pg */
  OPT_pie = 1259,                            /* -pie */
  OPT_pipe = 1260,                           /* -pipe */
  OPT_posix = 1261,                          /* -posix */
  OPT_print_file_name_ = 1262,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1263,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1264,          /* -print-multi-directory */
  OPT_print_multi_lib = 1265,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1266,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1267,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1268,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1269,               /* -print-prog-name= */
  OPT_print_search_dirs = 1270,              /* -print-search-dirs */
  OPT_print_sysroot = 1271,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1272,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1273,                        /* -profile */
  OPT_pthread = 1274,                        /* -pthread */
  OPT_quiet = 1275,                          /* -quiet */
  OPT_r = 1276,                              /* -r */
  OPT_rdynamic = 1277,                       /* -rdynamic */
  OPT_remap = 1278,                          /* -remap */
  OPT_s = 1279,                              /* -s */
  OPT_save_temps = 1280,                     /* -save-temps */
  OPT_save_temps_ = 1281,                    /* -save-temps= */
  OPT_shared = 1282,                         /* -shared */
  OPT_shared_libgcc = 1283,                  /* -shared-libgcc */
  /* OPT_specs = 1284, */                    /* -specs */
  OPT_specs_ = 1285,                         /* -specs= */
  OPT_static = 1286,                         /* -static */
  OPT_static_libasan = 1287,                 /* -static-libasan */
  OPT_static_libgcc = 1288,                  /* -static-libgcc */
  OPT_static_libgfortran = 1289,             /* -static-libgfortran */
  OPT_static_libgo = 1290,                   /* -static-libgo */
  OPT_static_liblsan = 1291,                 /* -static-liblsan */
  OPT_static_libmpx = 1292,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1293,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1294,               /* -static-libstdc++ */
  OPT_static_libtsan = 1295,                 /* -static-libtsan */
  OPT_static_libubsan = 1296,                /* -static-libubsan */
  OPT_static_pie = 1297,                     /* -static-pie */
  /* OPT_std_c__03 = 1298, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1299, */                /* -std=c++0x */
  OPT_std_c__11 = 1300,                      /* -std=c++11 */
  OPT_std_c__14 = 1301,                      /* -std=c++14 */
  OPT_std_c__17 = 1302,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1303, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1304, */                /* -std=c++1z */
  OPT_std_c__2a = 1305,                      /* -std=c++2a */
  OPT_std_c__98 = 1306,                      /* -std=c++98 */
  OPT_std_c11 = 1307,                        /* -std=c11 */
  OPT_std_c17 = 1308,                        /* -std=c17 */
  /* OPT_std_c18 = 1309, */                  /* -std=c18 */
  /* OPT_std_c1x = 1310, */                  /* -std=c1x */
  /* OPT_std_c89 = 1311, */                  /* -std=c89 */
  OPT_std_c90 = 1312,                        /* -std=c90 */
  OPT_std_c99 = 1313,                        /* -std=c99 */
  /* OPT_std_c9x = 1314, */                  /* -std=c9x */
  OPT_std_f2003 = 1315,                      /* -std=f2003 */
  OPT_std_f2008 = 1316,                      /* -std=f2008 */
  OPT_std_f2008ts = 1317,                    /* -std=f2008ts */
  OPT_std_f2018 = 1318,                      /* -std=f2018 */
  OPT_std_f95 = 1319,                        /* -std=f95 */
  OPT_std_gnu = 1320,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1321, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1322, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1323,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1324,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1325,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1326, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1327, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1328,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1329,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1330,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1331,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1332, */                /* -std=gnu18 */
  ...
  /* OPT_std_iso9899_2017 = 1343, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1344, */         /* -std=iso9899:2018 */
