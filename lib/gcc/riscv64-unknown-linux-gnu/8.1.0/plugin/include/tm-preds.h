/* Generated automatically by the program 'build/genpreds'
   from the machine description file '../../../source/riscv/riscv-gcc/gcc/config/riscv/riscv.md'.  */
...
extern int const_simm5_or_reg_operand (rtx, machine_mode);
extern int const_uimm5_or_reg_operand (rtx, machine_mode);
...
extern int const_twobit_operand (rtx, machine_mode);
...
extern int riscv_sync_memory_operand (rtx, machine_mode);
...
{
  if (c >= CONSTRAINT_Y && c <= CONSTRAINT_U)
    return;
